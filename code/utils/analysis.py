...
class Analyzer(object):
    ...
    def analyze_classification(self, y_pred, y_true, class_names, excluded_classes=None):
        ...
        # Confusion matrix
        ConfMatrix = metrics.confusion_matrix(y_true, y_pred)  #array(classnum,classnum)
        ...
        return {"total_accuracy": self.total_accuracy, "precision": self.precision, "recall": self.recall,
                "f1": self.f1, "support": self.support, "prec_avg": self.prec_avg, "rec_avg": self.rec_avg,"ConfMatrix":ConfMatrix, "ConfMatrix_normalized_row":self.ConfMatrix_normalized_row}
...
def test_save(device,addre,filep_valid_id,save_dir,exp,fov,offset=0,addre_state=None,addre_cp=None,CP=None,eval_metrics=False,return_preds=False):
    ################################################################################################################################
    ...
    # 关闭文件
    file.close()
    return preds[0], pad[0], trues[0], inputx[0], results

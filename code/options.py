...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--dimension', type=int, default=0,
                                 help='Number of dimension of trajectory')
        self.parser.add_argument('--tlen', type=int, default=0,
                                 help='max_lenth of traing trajectory')
        self.parser.add_argument('--tnum', type=int, default=0,
                                 help='Number of traning trajectory')
        self.parser.add_argument('--local', type=str, default='all_atten',
                                 help='local_attention or all_attention')
        self.parser.add_argument('--window_size', type=int, default=5,
                                 help='window_size of local_attention')
        self.parser.add_argument('--train_address', type=str, default='',
                                 help='address of train dataset')
        self.parser.add_argument('--valid_address', type=str, default='',
                                 help='address of valid dataset')

        self.parser.add_argument('--cnn_embedding', type=bool, default=False,
                                 help='using 1d cnn before position embedding')
        self.parser.add_argument('--whether_pos_encoding', type=bool, default=True,
                                 help='whether using position embedding')
        self.parser.add_argument('--cnn_layer', type=int, default=2,
                                 help='the number of cnn layer')
        self.parser.add_argument('--cnn_kernel', type=int, default=3,
                                 help='the size of cnn kernel')
        self.parser.add_argument('--cnn_outchannels', type=str, default='20,64',
                                 help='Comma separated string of each cnn layer output size')
        self.parser.add_argument('--ood_class', type=int, default=-1,
                                 help='the order of the ood class')
        self.parser.add_argument('--cnnencoderkernel', type=int, default=3,
                                 help='the order of the ood class')
        self.parser.add_argument('--cnnencoderhidden', type=int, default=32,
                                 help='the order of the ood class')
        self.parser.add_argument('--cnnencoderdilation', type=int, default=5,
                                 help='the order of the ood class')
        
        self.parser.add_argument('--gpus', nargs='+', type=int, default=[0,1,2,3],
                                 help='the order of cuda device')
    ...
    def parse(self):
        ...
        args.cnn_outchannels = [int(i) for i in args.cnn_outchannels.split(',')]
